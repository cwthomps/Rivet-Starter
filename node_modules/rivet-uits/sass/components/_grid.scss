...
@each $bp-name, $bp-size in $breakpoints {
    ...
    @each $columns, $width in $grid-columns {
        .rvt-grid__item-#{$columns}-#{$bp-name}-up {
            @extend %item-properties;
        }
...
// ------------------------------------------------------------------------
@each $columns, $width in $grid-columns {
    .rvt-grid__item-push-#{$columns} {
        left: $width * 1%;
    }
}

@each $columns, $width in $grid-columns {
    .rvt-grid__item-pull-#{$columns} {
        right: $width * 1%;
    }
}
...
@each $bp-name, $bp-size in $breakpoints {
    ...
    // but it seems like both should have the same behaviour
    // as a convienience.
    @if $bp-name == "sm" {
        @each $columns, $width in $grid-columns {
            .rvt-grid__item-push-#{$columns}-#{$bp-name} {
                left: $width * 1%;
            }
        }

        @each $columns, $width in $grid-columns {
            .rvt-grid__item-pull-#{$columns}-#{$bp-name} {
                right: $width * 1%;
            }
        }
    } @else {
