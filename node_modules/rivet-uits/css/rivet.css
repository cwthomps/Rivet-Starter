...
/**
 * Normalize Headig sizes since we're dealing with applications not
 * Editoral/article-like content. We'll make them slightly bigger than the
 * base font size.
 */
h1,
h2,
...
.rvt-alert {
  background-color: #eeeeee;
  border-left: 0.25rem solid #a7a9ab;
  padding: 1rem;
  position: relative;
}
...
.rvt-alert__title {
  ...
  /**
         ...
         * be used with the __message only and still get the propper padding
         * around all sides.
         */
...
a.rvt-badge--action:hover, a.rvt-badge--action-secondary:hover {
...
a.rvt-badge--error:hover, a.rvt-badge--error-secondary:hover {
...
.rvt-drawer__nav ul li button:focus {
  outline: none;
  -webkit-box-shadow: 0 0 0 0.125rem #ffffff, 0 0 0 0.2875rem #006298 !important;
          box-shadow: 0 0 0 0.125rem #ffffff, 0 0 0 0.2875rem #006298 !important;
}
...
.rvt-button-segmented a.rvt-buton {
  text-align: center;
}
...
.dropdown__menu a.rvt-is-selected,
...
.rvt-drawer-button.is-open {
  background-color: #eeeeee;
}

.rvt-drawer-button.is-open:hover {
  color: #333333;
}

.rvt-drawer-button.is-open:active:hover {
  padding-top: 0;
  background-color: #00314c;
}

.rvt-drawer-button.is-open:focus {
  background-color: #006298;
  -webkit-box-shadow: none;
          box-shadow: none;
  color: #ffffff;
...
.rvt-drawer-button.is-open:focus:hover {
  color: #ffffff;
}
...
.rvt-drawer-button.is-open > .rvt-drawer-button-close {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
}

.rvt-drawer-button.is-open > .rvt-drawer-button-open {
  display: none;
}
...
/**
 * NOTE: Need to be pretty specific here to overide default drawer
 * button trigger styles applied to "ul li a" above. This sets
 * an explicit height to match the other links insde the drawer.
 */
...
.rvt-plain-list {
  ...
  padding: 0;
  /**
     * So we can absolutely position stuff inside list items.
     */
  position: relative;
}
...
.rvt-tabs__tab {
  ...
  display: block;
  /**
         * Make the tabs (buttons) a little taller on mobile for a larger
         * hit area.
         */
  height: 2.75rem;
  line-height: 1;
...
.rvt-inline-alert--standalone.rvt-inline-alert--is-valid {
  border-left: 0.25rem solid #008a28;
  background-color: #ddf4ea;
}

.rvt-inline-alert--standalone.rvt-inline-alert--is-valid .rvt-inline-alert__message {
  color: #16521d;
}

.rvt-inline-alert--standalone.rvt-inline-alert--has-warning {
  border-left: 0.25rem solid #f5bb17;
  background-color: #fdf7e7;
}

.rvt-inline-alert--standalone.rvt-inline-alert--has-warning .rvt-inline-alert__message {
  color: #584416;
}
...
.rvt-inline-alert--standalone.rvt-inline-alert--has-info .rvt-inline-alert__message {
  color: #284c55;
}
